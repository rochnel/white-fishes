...
abstract class AppTheme {
  ...
  TextStyle get title => typography.bodyText2;

  Typography get typography => ThemeTypography(this);
}

class LightModeTheme extends AppTheme {
  late Color primaryColor = const Color(0xffE30612);
...
class ThemeTypography extends Typography {
  ...
  String get titleTFamily => 'Poppins';
  TextStyle get titleT => GoogleFonts.getFont(
        'Poppins',
